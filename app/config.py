...
class Settings(BaseSettings):
    service_role: str = "release-controller"
    service_name: str = "release_controller"
    service_title: str = "Release controller"
    service_description: str = "Owns canary rollout state, SLO checks and rollback decisions."
